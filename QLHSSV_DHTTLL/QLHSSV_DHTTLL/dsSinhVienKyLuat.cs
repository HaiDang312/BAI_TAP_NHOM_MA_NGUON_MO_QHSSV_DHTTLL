...
namespace GUI
{
    public partial class dsSinhVienKyLuat : Form
    {
        SqlConnection dbConn;
        DataTable ds;
        SqlDataAdapter adap;
        BindingSource bindSinhVien;
        public dsSinhVienKyLuat()
        {
            InitializeComponent();
        }
         DataTable SinhVien_DS()
        {
            ...
            dbConn.Open();
            adap.SelectCommand = new SqlCommand("SELECT SINHVIEN.MASV, HOSV, TENSV as [Tên SV], TENLOP,KHOA.TENKHOA,TENKL,NGAYKL,NGAYHH   FROM SINHVIEN,LOP,KHOA,KYLUAT,QTKYLUAT  WHERE (SINHVIEN.MALOP=LOP.MALOP) and (SINHVIEN.MAKHOA=KHOA.MAKHOA) and (SINHVIEN.MASV=QTKYLUAT.MASV) and (QTKYLUAT.MAKL=KYLUAT.MAKL)", dbConn);
            ds = new DataTable();
            adap.Fill(ds);
            dbConn.Close();
            return ds;
         ...
         DataTable SinhVienDS_Lop(string maLop)
        {
            ...
            adap = new SqlDataAdapter();
            dbConn.Open();
            adap.SelectCommand = new SqlCommand("SELECT SINHVIEN.MASV, HOSV, TENSV as [Tên SV], TENLOP,KHOA.TENKHOA,TENKL,NGAYKL,NGAYHH FROM SINHVIEN,LOP,KHOA,KYLUAT,QTKYLUAT  WHERE (SINHVIEN.MALOP=LOP.MALOP) and (SINHVIEN.MAKHOA=KHOA.MAKHOA) and (SINHVIEN.MASV=QTKYLUAT.MASV) and (QTKYLUAT.MAKL=KYLUAT.MAKL) and LOP.MALOP='" + maLop + "'", dbConn);
            ds = new DataTable();
            adap.Fill(ds);
            dbConn.Close();
            return ds;
        ...
        DataTable SinhVienDS_Khoa(string maKhoa)
        {
            ...
            adap = new SqlDataAdapter();
            dbConn.Open();
            adap.SelectCommand = new SqlCommand("SELECT SINHVIEN.MASV, HOSV, TENSV as [Tên SV], TENLOP,KHOA.TENKHOA,TENKL,NGAYKL,NGAYHH FROM SINHVIEN,LOP,KHOA,KYLUAT,QTKYLUAT  WHERE (SINHVIEN.MALOP=LOP.MALOP) and (SINHVIEN.MAKHOA=KHOA.MAKHOA) and (SINHVIEN.MASV=QTKYLUAT.MASV) and (QTKYLUAT.MAKL=KYLUAT.MAKL) and KHOA.MAKHOA='" + maKhoa + "'", dbConn);
            ds = new DataTable();
            adap.Fill(ds);
            dbConn.Close();
            return ds;
        ...
        DataTable SinhVienDS_KhoaVaLop(string maKhoa,string malop)
        {
            ...
            adap = new SqlDataAdapter();
            dbConn.Open();
            adap.SelectCommand = new SqlCommand("SELECT SINHVIEN.MASV, HOSV, TENSV as [Tên SV], TENLOP,KHOA.TENKHOA,TENKL,NGAYKL,NGAYHH FROM SINHVIEN,LOP,KHOA,KYLUAT,QTKYLUAT  WHERE (SINHVIEN.MALOP=LOP.MALOP) and (SINHVIEN.MAKHOA=KHOA.MAKHOA) and (SINHVIEN.MASV=QTKYLUAT.MASV) and (QTKYLUAT.MAKL=KYLUAT.MAKL) and KHOA.MAKHOA='" + maKhoa + "' and LOP.MALOP='" + malop + "'", dbConn);
            ds = new DataTable();
            adap.Fill(ds);
            dbConn.Close();
            return ds;
        ...
        private void dsSinhVienKyLuat_Load(object sender, EventArgs e)
        {
            ...
            dataDT.Columns[5].HeaderText = "Tên kỹ luật";
            dataDT.Columns[6].HeaderText = "Ngày kỹ luật";
            dataDT.Columns[7].HeaderText = "Ngày kết thúc";
