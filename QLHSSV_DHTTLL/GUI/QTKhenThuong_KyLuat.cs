    ...
    public partial class QTKhenThuong_KyLuat : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (radKT.Checked)
            {
                try
                {
                    DTO_QTKhenThuong qtkt = new DTO_QTKhenThuong(txtMaSV.Text, cbMaKtKl.SelectedValue.ToString(), DateTime.Parse(txtNgayKtKl.Text).ToString("MM/dd/yyyy"));
            ...
            else
            {
                try
                {
                    ...
                    DTO_QTKyLuat qtkl = new DTO_QTKyLuat(txtMaSV.Text, cbMaKl.SelectedValue.ToString(), DateTime.Parse(txtNgayKtKl.Text).ToString("MM/dd/yyyy"), DateTime.Parse(txtNgayHH.Text).ToString("MM/dd/yyyy"));
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            if (radKT.Checked)
            {
                try
                {
                    bus_qtkt.xoaQTKT(txtMaSV.Text, cbMaKtKl.SelectedValue.ToString());
                    txtNgayKtKl.Text = "";
            ...
            else
            {
                try
                {
                    bus_qtkl.xoaQTKL(txtMaSV.Text, cbMaKl.SelectedValue.ToString());
                    txtNgayKtKl.Text = "";
                    txtNgayHH.Text = "";
                    MessageBox.Show("Xóa thành công !", "THÔNG BÁO", MessageBoxButtons.OK);
                }
