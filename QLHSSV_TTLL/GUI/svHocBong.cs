...
namespace GUI
{
    public partial class svHocBong : Form
    {
        ...
        private void binding()
        {
            ...
            combMaSV.DataBindings.Clear();
            combMaSV.DataBindings.Add("Text", dataHB.DataSource, "MASV");
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            try
            {
                DTO_SVHocBong svHB = new DTO_SVHocBong(combMaHB.SelectedValue.ToString(), combMaSV.SelectedValue.ToString(),txtHocKy.Text);
        ...
        {
            combMaSV.DataSource = bus_sv.SinhVien();
            combMaSV.DisplayMember = "MASV";
            combMaSV.ValueMember = "MASV";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                bus_HB.xoaSVHB(combMaHB.SelectedValue.ToString(), combMaSV.SelectedValue.ToString(), txtHocKy.Text);
                combMaHB.Text = "--Chọn--";
                combMaSV.Text = "--Chọn--";
                txtHocKy.Text = "";
                this.svHocBong_Load(sender, e);
